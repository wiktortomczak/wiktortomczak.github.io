...
import {Uint8Arrays} from 'https://wiktortomczak.github.io/vb/__packages__/base/binary.mjs';
import Iterables, {AsyncIterables} from 'https://wiktortomczak.github.io/vb/__packages__/base/iterables.mjs';
...
export default class Fetch {
  ...
  static postJson(uri, json) {
    return this.post(uri, JSON.stringify(json), 'application/json');
  }
