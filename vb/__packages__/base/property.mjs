...
import ChangeEmitter from 'https://wiktortomczak.github.io/vb/__packages__/base/change-emitter.mjs';
import {getArgumentNames} from 'https://wiktortomczak.github.io/vb/__packages__/base/inspect.mjs';
