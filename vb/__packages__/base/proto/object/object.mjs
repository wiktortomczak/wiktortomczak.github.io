...
import Fetch from 'https://wiktortomczak.github.io/vb/__packages__/base/fetch.mjs';
import JSONDecoder from 'https://wiktortomczak.github.io/vb/__packages__/base/json-decoder.mjs';
import Objects from 'https://wiktortomczak.github.io/vb/__packages__/base/objects.mjs';

import MessageExt, {MessageExtClassFactory, createMessageExtClassesFromFileDescriptorSetJson} from 'https://wiktortomczak.github.io/vb/__packages__/base/proto/ext/message.mjs';
import ObjectDescriptor from 'https://wiktortomczak.github.io/vb/__packages__/base/proto/object/descriptor.mjs';
...
export default class ObjectView extends MessageExt {
  ...
  static create(...args) {
    const obj = super.create(...args);
    const wrapperClass = this._wrapperClass;
    if (wrapperClass) {
      new wrapperClass(obj);  // Sets this.wrapper.
    }
    
    return obj;
  }

  static setWrapper(wrapperClass) {
    assert(!this._wrapperClass);
    this._wrapperClass = wrapperClass;
  }

  static setDeriveWrapper(deriveWrapperClass) {
    this.setWrapper(Classes.createDerivedClass(
      ObjectViewWrapperBase, deriveWrapperClass));
  }
...
export class ObjectViewWrapperBase {

  constructor(obj) {
    assert(obj instanceof this.constructor.objectViewClass);
    this._obj = obj;
    obj.wrapper = this;
  }
}
