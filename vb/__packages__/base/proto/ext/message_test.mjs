...
describe('MessageExt', function () {
  ...
  it('set & delete li', function () {
    _listenChanges(m.li.field);
    m.updateJson(['.li[0]', 1]);
    _assertMessage({li: [1]}, {subtreeChanges: 1});
    _assertChanges(m.li.field, {ownChanges: 1, subtreeChanges: 1});
    m.updateJson(['.li[1]', 2]);
    _assertMessage({li: [1, 2]}, {subtreeChanges: 2});
    _assertChanges(m.li.field, {ownChanges: 2, subtreeChanges: 2});
    m.updateJson(['.li[0]', 3]);
    _assertMessage({li: [3, 2]}, {subtreeChanges: 3});
    _assertChanges(m.li.field, {ownChanges: 2, subtreeChanges: 3});
    m.updateJson(['.li[1]', null]);
    _assertMessage({li: [3]}, {subtreeChanges: 4});
    _assertChanges(m.li.field, {ownChanges: 3, subtreeChanges: 4});
    m.updateJson(['.li[0]', null]);
    _assertMessage({}, {subtreeChanges: 5});
    _assertChanges(m.li.field, {ownChanges: 4, subtreeChanges: 5});
  });

  it('set & delete mi', function () {
    _listenChanges(m.mi.field);
    m.updateJson(['.mi["a"]', 1]);
    _assertMessage({mi: {'a': 1}}, {subtreeChanges: 1});
    _assertChanges(m.mi.field, {ownChanges: 1, subtreeChanges: 1});
    m.updateJson(['.mi["b"]', 2]);
    _assertMessage({mi: {'a': 1, 'b': 2}}, {subtreeChanges: 2});
    _assertChanges(m.mi.field, {ownChanges: 2, subtreeChanges: 2});
    m.updateJson(['.mi["a"]', 3]);
    _assertMessage({mi: {'a': 3, 'b': 2}}, {subtreeChanges: 3});
    _assertChanges(m.mi.field, {ownChanges: 2, subtreeChanges: 3});
    m.updateJson(['.mi["a"]', null]);
    _assertMessage({mi: {'b': 2}}, {subtreeChanges: 4});
    _assertChanges(m.mi.field, {ownChanges: 3, subtreeChanges: 4});
    m.updateJson(['.mi["b"]', null]);
    _assertMessage({}, {subtreeChanges: 5});
    _assertChanges(m.mi.field, {ownChanges: 4, subtreeChanges: 5});
  });
  ...
  it('set & delete lm', function () {
    _listenChanges(m.lm.field);
    m.updateJson(['.lm[0]', {}]);
    _assertMessage({lm: [{}]}, {subtreeChanges: 1});
    _assertChanges(m.lm.field, {ownChanges: 1, subtreeChanges: 1});
    m.updateJson(['.lm[0].i', 1]);
    _assertMessage({lm: [{i: 1}]}, {subtreeChanges: 2});
    _assertChanges(m.lm.field, {ownChanges: 1, subtreeChanges: 2});
    m.updateJson(['.lm[1]', {i: 2}]);
    _assertMessage({lm: [{i: 1}, {i: 2}]}, {subtreeChanges: 3});
    _assertChanges(m.lm.field, {ownChanges: 2, subtreeChanges: 3});
    m.updateJson(['.lm[0].i', 3]);
    _assertMessage({lm: [{i: 3}, {i: 2}]}, {subtreeChanges: 4});
    _assertChanges(m.lm.field, {ownChanges: 2, subtreeChanges: 4});
    m.updateJson(['.lm[1]', {i: 4}]);
    _assertMessage({lm: [{i: 3}, {i: 4}]}, {subtreeChanges: 5});
    _assertChanges(m.lm.field, {ownChanges: 2, subtreeChanges: 5});
    m.updateJson(['.lm[1]', null]);
    _assertMessage({lm: [{i: 3}]}, {subtreeChanges: 6});
    _assertChanges(m.lm.field, {ownChanges: 3, subtreeChanges: 6});
    m.updateJson(['.lm[0]', null]);
    _assertMessage({}, {subtreeChanges: 7});
    _assertChanges(m.lm.field, {ownChanges: 4, subtreeChanges: 7});
  });

  it('set & delete mm', function () {
    _listenChanges(m.mm.field);
    m.updateJson(['.mm["a"]', {}]);
    _assertMessage({mm: {a: {}}}, {subtreeChanges: 1});
    _assertChanges(m.mm.field, {ownChanges: 1, subtreeChanges: 1});
    m.updateJson(['.mm["a"].i', 1]);
    _assertMessage({mm: {a: {i: 1}}}, {subtreeChanges: 2});
    _assertChanges(m.mm.field, {ownChanges: 1, subtreeChanges: 2});
    m.updateJson(['.mm["b"]', {i: 2}]);
    _assertMessage({mm: {a: {i: 1}, b: {i: 2}}}, {subtreeChanges: 3});
    _assertChanges(m.mm.field, {ownChanges: 2, subtreeChanges: 3});
    m.updateJson(['.mm["a"].i', 3]);
    _assertMessage({mm: {a: {i: 3}, b: {i: 2}}}, {subtreeChanges: 4});
    _assertChanges(m.mm.field, {ownChanges: 2, subtreeChanges: 4});
    m.updateJson(['.mm["a"]', null]);
    _assertMessage({mm: {b: {i: 2}}}, {subtreeChanges: 5});
    _assertChanges(m.mm.field, {ownChanges: 3, subtreeChanges: 5});
    m.updateJson(['.mm["b"]', null]);
    _assertMessage({}, {subtreeChanges: 6});
    _assertChanges(m.mm.field, {ownChanges: 4, subtreeChanges: 6});
  });
  ...
  function _listenChanges(field) {
    field.ownChanges = field.subtreeChanges = 0;
    field.ownChange.listen(() => ++field.ownChanges);
    field.subtreeChange.listen(() => ++field.subtreeChanges);
  }
  ...
  function _assertMessage(expectedFields, expectedEvents) {
    ...
    _assertChanges(m, expectedEvents);
  }

  function _assertChanges(field, expectedEvents) {
    const {ownChanges, subtreeChanges} = expectedEvents || {};
    chai.assert.equal(field.ownChanges, ownChanges || 0);
    chai.assert.equal(field.subtreeChanges, subtreeChanges || 0);
  }
