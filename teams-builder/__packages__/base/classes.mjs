...
export default class Classes {
  ...
  static mixInto(mixinClass, targetClass) {
    this.getBaseClassChain(mixinClass).reverse().forEach(baseChainClass => {
      ...
      // if (Object.hasOwnProperty(baseChainClass.prototype, 'constructor')) {
      //   assert(!Object.hasOwnProperty(targetClass.prototype, 'constructor'));
      // }
      Objects.copyOwnProperties(baseChainClass.prototype, targetClass.prototype, 'constructor');
      Objects.copyOwnProperties(baseChainClass, targetClass, 'prototype', 'name');
    });
  }
  ...
  static constructor(class_, constructor) {
    return new Proxy(function () {}, {
      construct(target, args, newTarget) {
        return Reflect.construct(constructor, args, class_);
      }
    });
  }
};
