...
import '/zuzia/__packages__/react/umd/react.production.min.js';
const React = window.React;

import Arrays from '/zuzia/__packages__/base/arrays.mjs';
import assert from '/zuzia/__packages__/base/assert.mjs';
import Dates from '/zuzia/__packages__/base/dates.mjs';
import Entries from '/zuzia/__packages__/base/entries.mjs';
import EventSource from '/zuzia/__packages__/base/event-source.mjs';
import IdMap from '/zuzia/__packages__/base/id-map.mjs';
import Objects from '/zuzia/__packages__/base/objects.mjs';
import Promises from '/zuzia/__packages__/base/promises.mjs';
import range from '/zuzia/__packages__/base/range.mjs';
import {cE, fragment, Components, button, Dropdown, TextInput} from '/zuzia/__packages__/base/react.mjs';
import Sets from '/zuzia/__packages__/base/sets.mjs';
import Stream from '/zuzia/__packages__/base/stream.mjs';
import Types from '/zuzia/__packages__/base/types.mjs';

import Graph from '/zuzia/graph.mjs';
...
class SensorSignalControls extends React.Component {
  ...
  _stopSensorRecording() {
    ...
    this._recordingDatabase.saveRecording(
...
class RecordingEditor extends React.Component {
  ...
  _copyRecording() {
    this._recordingDatabase.saveRecording(null /* name */, this._recording);
  }
...
class FakeRecordingDatabase {
  ...
  saveRecording(recordingName, recording) {
    if (recordingName) {
