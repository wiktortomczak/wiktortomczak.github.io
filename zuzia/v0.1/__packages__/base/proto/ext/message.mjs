...
import Classes from '/zuzia/v0.1/__packages__/base/classes.mjs';
...
import MessageExtDescriptor from '/zuzia/v0.1/__packages__/base/proto/ext/descriptor.mjs';
...
class CompositeField {
  ...
  _notifyChange(isOwnChange) {
    if (this._parent) {
      this._parent._notifyChange(isOwnChange);
    }
  }
  ...
  _deferReferences(fieldDescriptor, func) {
    const deferredReferences = this._context.update.deferredReferences;
...
class UnaryField {
  ...
  _setFromObject(obj) {
    this._parent._setFromObject({[this._parentEntryKey]: obj}, false /* clear */);
  }
...
class MessageEntriesMixin extends CompositeEntriesMixin {
  ...
  _createSubmessageImpl(obj, fieldDescriptor) {
    ...
    const submessage = new messageExtClass(null, null, this._context);
    if (obj) {
      submessage._setFromObject(obj, false /* clear */);
    }
    return submessage;
  }
...
Classes.mix(CompositeField, ScalarEntriesMixin, MessageEntriesMixin) {
  ...
  // Change of value of any scalar field or change of container entry.
  get ownChange() {
...
export class MessageExtClassFactory {
  ...
  create(descriptor) {
    ...
    return descriptor.messageExtClass = Classes.createClass(
