...
import '/zuzia/v0.1/__packages__/base/__packages__/react/umd/react.production.min.js';
const React = window.React;
import '/zuzia/v0.1/__packages__/base/__packages__/react-dom/umd/react-dom.production.min.js';
const ReactDOM = window.ReactDOM;

import Iterables from '/zuzia/v0.1/__packages__/base/iterables.mjs';
import Objects from '/zuzia/v0.1/__packages__/base/objects.mjs';
import ObjectView from '/zuzia/v0.1/__packages__/base/proto/object/object.mjs';
import {cE, fragment, AsyncStateComponent, Components} from '/zuzia/v0.1/__packages__/base/react.mjs';
import Types from '/zuzia/v0.1/__packages__/base/types.mjs';

import MessageParser from '/zuzia/v0.1/__packages__/base/proto/util/message-parser.mjs';
import Messages from '/zuzia/v0.1/__packages__/base/proto/util/messages.mjs';
