...
import '/zuzia/v0.2/__packages__/base/proto/ext/testing/message.pbext.mjs';
...
describe('MessageExt', function () {
  ...
  it('set & delete lm', function () {
    ...
    _assertMessage({lm: [{i: 3}, {i: 4}]}, {subtreeChanges: 4});
    // _assertChanges(m.lm.field, {ownChanges: 1, subtreeChanges: 1});

    m.updateJson(['.lm[1]', null]);
    _assertMessage({lm: [{i: 3}]}, {subtreeChanges: 5});
    _assertChanges(m.lm.field, {ownChanges: 3, subtreeChanges: 5});
    m.updateJson(['.lm[0]', null]);
    _assertMessage({}, {subtreeChanges: 6});
    _assertChanges(m.lm.field, {ownChanges: 4, subtreeChanges: 6});
  });
