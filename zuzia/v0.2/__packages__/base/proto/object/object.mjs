...
import JSONDecoder from '/zuzia/v0.2/__packages__/base/json-decoder.mjs';
import Objects from '/zuzia/v0.2/__packages__/base/objects.mjs';

import MessageExt, {MessageExtClassFactory, createMessageExtClassesFromFileDescriptorSetJson} from '/zuzia/v0.2/__packages__/base/proto/ext/message.mjs';
import ObjectDescriptor from '/zuzia/v0.2/__packages__/base/proto/object/descriptor.mjs';
